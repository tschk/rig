...
cargo install rigpkg   # or: cargo install --path ../.. / --git https://github.com/tschk/rig
rig init
rig add --rust rx4
zig build run
```
...
```text
zig-host-rx4: native rx4 ABI=2 version=0.7.1
zig-host-rx4: prompt_smoke=0
```
...
Symbols: `rx4_abi_version`, `rx4_version`, `rx4_agent_new`, `rx4_agent_free`, `rx4_prompt_smoke` (ABI 2).
